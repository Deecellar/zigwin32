...
pub const NCRYPT_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(NCRYPT_FLAGS,@enumFromInt(
              (if (o.BCRYPT_PAD_NONE == 1) @intFromEnum(NCRYPT_FLAGS.BCRYPT_PAD_NONE) else 0)
            | (if (o.BCRYPT_PAD_OAEP == 1) @intFromEnum(NCRYPT_FLAGS.BCRYPT_PAD_OAEP) else 0)
            | (if (o.BCRYPT_PAD_PKCS1 == 1) @intFromEnum(NCRYPT_FLAGS.BCRYPT_PAD_PKCS1) else 0)
            | (if (o.BCRYPT_PAD_PSS == 1) @intFromEnum(NCRYPT_FLAGS.BCRYPT_PAD_PSS) else 0)
            | (if (o.NCRYPT_SILENT_FLAG == 1) @intFromEnum(NCRYPT_FLAGS.NCRYPT_SILENT_FLAG) else 0)
            | (if (o.NCRYPT_MACHINE_KEY_FLAG == 1) @intFromEnum(NCRYPT_FLAGS.NCRYPT_MACHINE_KEY_FLAG) else 0)
            | (if (o.NCRYPT_OVERWRITE_KEY_FLAG == 1) @intFromEnum(NCRYPT_FLAGS.NCRYPT_OVERWRITE_KEY_FLAG) else 0)
            | (if (o.NCRYPT_WRITE_KEY_TO_LEGACY_STORE_FLAG == 1) @intFromEnum(NCRYPT_FLAGS.NCRYPT_WRITE_KEY_TO_LEGACY_STORE_FLAG) else 0)
            | (if (o.NCRYPT_PERSIST_FLAG == 1) @intFromEnum(NCRYPT_FLAGS.NCRYPT_PERSIST_FLAG) else 0)
            | (if (o.NCRYPT_PERSIST_ONLY_FLAG == 1) @intFromEnum(NCRYPT_FLAGS.NCRYPT_PERSIST_ONLY_FLAG) else 0)
        ));
    }
};
